...
var SendRawTransaction = /** @class */ (function (_super) {
    ...
    SendRawTransaction.prototype.run = function () {
    ...
    SendRawTransaction.description = 'describe the command here';
    SendRawTransaction.flags = {
    ...
    SendRawTransaction.args = [{ name: 'file' }];
